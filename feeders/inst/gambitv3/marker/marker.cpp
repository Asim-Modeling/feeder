...
UINT64  
TRACE_MARKER_CLASS::GetMarkerPc (const UINT32 tid,
                     const UINT32 markerID)
{
    IADDR_CLASS tmp_address= thread[tid].addr[markerID];
    UINT64 address=tmp_address.GetBundleAddr() | tmp_address.GetSyllableIndex();
    return address;
}
