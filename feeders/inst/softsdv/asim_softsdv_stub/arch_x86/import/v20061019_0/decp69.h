...
typedef enum IA_Decoder_Inst_Id_e
{
	...
	X86_NOP_1F_MME,					/**  opcode:  0F 1F       **/
	X86_NOP_1E_MME,					/**  opcode:  0F 1E       **/
	X86_NOP_1D_MME,					/**  opcode:  0F 1D       **/
	X86_NOP_1C_MME,					/**  opcode:  0F 1C       **/
	X86_NOP_1B_MME,					/**  opcode:  0F 1B       **/
	X86_NOP_1A_MME,					/**  opcode:  0F 1A       **/
	X86_NOP_19_MME,					/**  opcode:  0F 19       **/
	...
	X86_EMONITOR_MEROM,				/**  opcode:  0F 01 D0    **/
	X86_EMONITORQ_MEROM,			/**  opcode:  0F 01 D0    **/
	X86_EREAD_MEROM,				/**  opcode:  0F 01 D1    **/
	X86_EREADQ_MEROM,				/**  opcode:  0F 01 D1    **/
	X86_ERET_MEROM,					/**  opcode:  0F 01 D2    **/
	X86_ERETQ_MEROM,				/**  opcode:  0F 01 D2    **/
	X86_SXFR_MEROM,					/**  opcode:  0F 3B       **/
	X86_TXSETHANDLER_L,				/**  opcode:  0F 3C       **/
	X86_TXSETHANDLER_Q,				/**  opcode:  0F 3C       **/
	X86_TXHANDLERCTRLUPDATE,		/**  opcode:  0F 3D       **/
	X86_TXBEGIN,					/**  opcode:  0F 3E /0    **/
	X86_TXBEGIN_I,					/**  opcode:  0F 3E /1    **/
	X86_TXEND,						/**  opcode:  0F 3E /2    **/
	X86_TXABORT,					/**  opcode:  0F 3E /3    **/
	X86_TXHRET,						/**  opcode:  0F 3E /4    **/
	X86_TXPUSHT_L,					/**  opcode:  0F 3E /5    **/
	X86_TXPUSHT_Q,					/**  opcode:  0F 3E /5    **/
	X86_TXPOPT_L,					/**  opcode:  0F 3E /6    **/
	X86_TXPOPT_Q,					/**  opcode:  0F 3E /6    **/
	X86_BLENDPD_SNI,				/**  opcode:  0F 3A 0D    **/
	X86_BLENDPS_SNI,				/**  opcode:  0F 3A 0C    **/
	X86_BLENDVPD_SNI,				/**  opcode:  0F 38 15    **/
	X86_BLENDVPS_SNI,				/**  opcode:  0F 38 14    **/
	X86_DPPD_SNI,					/**  opcode:  0F 3A 41    **/
	X86_DPPS_SNI,					/**  opcode:  0F 3A 40    **/
	X86_EXTRACTPS_SNI,				/**  opcode:  0F 3A 17    **/
	X86_INSERTPS_SNI,				/**  opcode:  0F 3A 21    **/
	X86_MOVNTDQA_SNI,				/**  opcode:  0F 38 2A    **/
	X86_MPSAD_SNI,					/**  opcode:  0F 3A 42    **/
	X86_PACKUSDW_SNI,				/**  opcode:  0F 38 2B    **/
	X86_PBLENDVB_SNI,				/**  opcode:  0F 38 10    **/
	X86_PBLENDW_SNI,				/**  opcode:  0F 3A 0E    **/
	X86_PCMPEQQ_SNI,				/**  opcode:  0F 38 29    **/
	X86_PEXTRB_SNI,					/**  opcode:  0F 3A 14    **/
	X86_PEXTRD_SNI,					/**  opcode:  0F 3A 16    **/
	X86_PEXTRQ_SNI,					/**  opcode:  0F 3A 16    **/
	X86_PEXTRW_SNI,					/**  opcode:  0F 3A 15    **/
	X86_PHMINPOSUW_SNI,				/**  opcode:  0F 38 41    **/
	X86_PINSRB_SNI,					/**  opcode:  0F 3A 20    **/
	X86_PINSRD_SNI,					/**  opcode:  0F 3A 22    **/
	X86_PINSRQ_SNI,					/**  opcode:  0F 3A 22    **/
	X86_PMAXSB_SNI,					/**  opcode:  0F 38 3C    **/
	X86_PMAXSD_SNI,					/**  opcode:  0F 38 3D    **/
	X86_PMAXUD_SNI,					/**  opcode:  0F 38 3F    **/
	X86_PMAXUW_SNI,					/**  opcode:  0F 38 3E    **/
	X86_PMINSB_SNI,					/**  opcode:  0F 38 38    **/
	X86_PMINSD_SNI,					/**  opcode:  0F 38 39    **/
	X86_PMINUD_SNI,					/**  opcode:  0F 38 3B    **/
	X86_PMINUW_SNI,					/**  opcode:  0F 38 3A    **/
	X86_PMOVSXBW_SNI,				/**  opcode:  0F 38 20    **/
	X86_PMOVSXBD_SNI,				/**  opcode:  0F 38 21    **/
	X86_PMOVSXBQ_SNI,				/**  opcode:  0F 38 22    **/
	X86_PMOVSXWD_SNI,				/**  opcode:  0F 38 23    **/
	X86_PMOVSXWQ_SNI,				/**  opcode:  0F 38 24    **/
	X86_PMOVSXDQ_SNI,				/**  opcode:  0F 38 25    **/
	X86_PMOVZXBW_SNI,				/**  opcode:  0F 38 30    **/
	X86_PMOVZXBD_SNI,				/**  opcode:  0F 38 31    **/
	X86_PMOVZXBQ_SNI,				/**  opcode:  0F 38 32    **/
	X86_PMOVZXWD_SNI,				/**  opcode:  0F 38 33    **/
	X86_PMOVZXWQ_SNI,				/**  opcode:  0F 38 34    **/
	X86_PMOVZXDQ_SNI,				/**  opcode:  0F 38 35    **/
	X86_PMULDQ_SNI,					/**  opcode:  0F 38 28    **/
	X86_PMULLD_SNI,					/**  opcode:  0F 38 40    **/
	X86_PTEST_SNI,					/**  opcode:  0F 38 17    **/
	X86_ROUNDPD_SNI,				/**  opcode:  0F 3A 09    **/
	X86_ROUNDPS_SNI,				/**  opcode:  0F 3A 08    **/
	X86_ROUNDSD_SNI,				/**  opcode:  0F 3A 0B    **/
	X86_ROUNDSS_SNI,				/**  opcode:  0F 3A 0A    **/
	X86_LAST_INST,
...
typedef enum
{
	...
	IA_DECODER_CPU_PENRYN=14,     /* SNI encodings */
...
/* Flag 54 (extended 23) Instruction belongs to SNI */
#define IA_DECODER_BIT_SNI	        0x00800000
/* Macros
==============================================================================*/
...
/* is the instruction part of SNI set */
#define IA_DECODER_SNI(di) ((di)->ext_flags & IA_DECODER_BIT_SNI)
