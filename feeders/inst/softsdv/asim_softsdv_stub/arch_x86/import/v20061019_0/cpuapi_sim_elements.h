...
#define CPUAPI_SIM_ALIVE_CPUS_SIZE               (256/*max num of cpus*/ / 8/*num of bits in byte*/)
...
#define CPUAPI_EVENT_SIMUL_APP_MARK              "event.cpuapi.simul.application_mark"
#define CPUAPI_EVENT_GUEST_HOST_MARK             "event.cpuapi.guest_host.mark"

// Power management
#define CPUAPI_EVENT_STOP_GRANT                  "event.cpuapi.stop_grant"
