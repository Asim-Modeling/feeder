...
#if defined(WINNT)
#define NATIVE_UINT64 unsigned __int64
#elif defined(UNIX)
#define NATIVE_UINT64 unsigned long long
#endif
...
#define IEL_CONVERT2S(x, y0, y1) IEL_CONVERT4(x, y0, y1, \
                                            y1 & 0x80000000) ? -1 : 0, \
                                            y1 & 0x80000000) ? -1 : 0))
#define IEL_CONVERT1S(x, y0)     IEL_CONVERT4(x, y0, (y0 & 0x80000000) ? -1 : 0, \
                                            (y0 & 0x80000000) ? -1 : 0, \
                                            (y0 & 0x80000000) ? -1 : 0)
#define IEL_CONVERT IEL_CONVERT4


#define IEL_U64TONATIVE(x) ((((NATIVE_UINT64)(IEL_GETDW1(x))) << 32) | (IEL_GETDW0(x)))

#define IEL_NATIVETOU64(x,y) IEL_CONVERT2(x,y&((((NATIVE_UINT64)1)<<32)-1),(y>>32))
