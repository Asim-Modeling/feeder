...
typedef enum EM_decoder_reg_type
{
	...
	EM_DECODER_APP_CSD_REG,
	EM_DECODER_APP_PFS_REG,
	EM_DECODER_PR_REG,
	EM_DECODER_PR_ROT_REG,
	EM_DECODER_PSR_REG,
	EM_DECODER_PSR_L_REG,
	EM_DECODER_PSR_UM_REG = EM_DECODER_PSR_L_REG,
...
typedef struct EM_decoder_compact_operand_info
{
    EM_Decoder_Operand_Type     type;
    unsigned long               oper_flags;
	union {
...
} EM_Decoder_Compact_Operand_Info;
...
typedef struct em_decoder_compact_info
{
    EM_Decoder_Inst_Id               inst;
    EM_Decoder_Reg_Info              pred;
    EM_Decoder_Compact_Operand_Info  src1;
    EM_Decoder_Compact_Operand_Info  src2;
    EM_Decoder_Compact_Operand_Info  src3;
    EM_Decoder_Compact_Operand_Info  src4;
    EM_Decoder_Compact_Operand_Info  src5;
    EM_Decoder_Compact_Operand_Info  dst1;
    EM_Decoder_Compact_Operand_Info  dst2;
	EM_Decoder_EM_Info               EM_info;
    void *                           client_info;
    unsigned long                    flags;
    unsigned char                    size;
	const EM_Decoder_static_info_t   *static_info;
} EM_Decoder_Compact_Info;
...
typedef struct em_decoder_compact_bundle_info
{
	unsigned int          	    inst_num;
	EM_Decoder_EM_Bundle_Info	em_bundle_info;
	EM_Decoder_Err           	error[3];
	EM_Decoder_Compact_Info     inst_info[3];
} EM_Decoder_Compact_Bundle_Info;
...
EM_Decoder_Err em_decoder_compact_decode(const EM_Decoder_Id  id,
						         const unsigned char       * code,
						         const int			         max_code_size,
						         const EM_IL		         location,
						         EM_Decoder_Compact_Info   * decoder_info);
...
EM_Decoder_Err em_decoder_decode_inst(const EM_Decoder_Id    id,
                                      U64                    instr,
                                      const EM_temp_role_t   pseudo_trole,
                                      const U128           * bundle_p,
                                      EM_Decoder_Info      * decoder_info);
 ...
 EM_Decoder_Err em_decoder_compact_decode_bundle(const EM_Decoder_Id id,
								 const unsigned char            * code,
								 const int                        max_size,
								 EM_Decoder_Compact_Bundle_Info * bundle_info);
