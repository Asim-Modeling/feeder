...
#define EM_IS_ITANIUM2_INST(impls_flag) \
		(EM_IS_GENERIC_INST(impls_flag) || (impls_flag & Impl_Ipref) || (impls_flag & Impl_Itanium2))
...
#define EM_FRAME_RRB_GR_MASK 0x1fc0000
#define EM_FRAME_RRB_GR_POS 18
...
#define EM_NUM_OF_vis_PMCREGS       32 /* Number of visible PMC to oml */
#define EM_NUM_OF_PMCREGS         1024 /* Number of PMC based on Montecito */
#define EM_NUM_OF_vis_PMDREGS       32 /* Number of visible PMD to oml */
#define EM_NUM_OF_PMDREGS         1024 /* Number of PMD based on Montecito */
#define EM_NUM_OF_MSREGS          2048 /* Number of MSR based on Montecito */
...
/* Interruption Priorities, taken from Table 5-6 in spec version 2.1 (Montecito) */
typedef enum EM_interruption_e
{
    ...
    EM_INTR_INITIALIZATION_INTERRUPT              = 3,
    EM_INTR_PLATFORM_MANAGEMENT_INTERRUPT         = 4,
    EM_INTR_EXTERNAL_INTERRUPT                    = 5,
    /* Faults: IA64 */
    EM_INTR_IR_UNIMPLEMENTED_DATA_ADDRESS_FAULT   = 6,
    EM_INTR_IR_DATA_NESTED_TLB_FAULT              = 7,
    EM_INTR_IR_ALT_DATA_TLB_FAULT                 = 8,
    EM_INTR_IR_VHPT_DATA_FAULT                    = 9,
    EM_INTR_IR_DATA_TLB_FAULT                     = 10,
    EM_INTR_IR_DATA_PAGE_NOT_PRESENT_FAULT        = 11,
    EM_INTR_IR_DATA_NAT_PAGE_CONSUMPTION_FAULT    = 12,
    EM_INTR_IR_DATA_KEY_MISS_FAULT                = 13,
    EM_INTR_IR_DATA_KEY_PERMISSION_FAULT          = 14,
    EM_INTR_IR_DATA_ACCESS_RIGHT_FAULT            = 15,
    EM_INTR_IR_DATA_ACCESS_BIT_FAULT              = 16,
    EM_INTR_IR_DATA_DEBUG_FAULT                   = 17,
    /* Faults: IA32 */
    EM_INTR_IA_INST_BREAKPOINT_FAULT              = 18,
    EM_INTR_IA_CODE_FETCH_FAULT                   = 19,
    /* Faults: IA32, IA64 */
    EM_INTR_INST_ALT_TLB_FAULT                    = 20,
    EM_INTR_INST_VHPT_FAULT                       = 21,
    EM_INTR_INST_TLB_FAULT                        = 22,
    EM_INTR_INST_PAGE_NOT_PRESENT_FAULT           = 23,
    EM_INTR_INST_NAT_PAGE_CONSUMPTION_FAULT       = 24,
    EM_INTR_INST_KEY_MISS_FAULT                   = 25,
    EM_INTR_INST_KEY_PERMISSION_FAULT             = 26,
    EM_INTR_INST_ACCESS_RIGHT_FAULT               = 27,
    EM_INTR_INST_ACCESS_BIT_FAULT                 = 28,
    /* Faults: IA64 */
    EM_INTR_INST_DEBUG_FAULT                      = 29,
    /* Faults: IA32 */
    EM_INTR_IA_INST_LENGTH_FAULT                  = 30,
    EM_INTR_IA_INVALID_OPCODE_FAULT               = 31,
    EM_INTR_IA_INST_INTERCEPT_FAULT               = 32,
    /* Faults: IA64 */
    EM_INTR_ILLEGAL_OPERATION_FAULT               = 33,
    EM_INTR_ILLEGAL_DEPENDENCY_FAULT              = 34,
    EM_INTR_BREAK_INSTRUCTION_FAULT               = 35,
    EM_INTR_PRIVILEGED_OPERATION_FAULT            = 36,
    /* Faults: IA32, IA64 */
    EM_INTR_DISABLED_FP_REGISTER_FAULT            = 37,
    EM_INTR_DISABLED_ISA_TRANSITION_FAULT         = 38,
    /* Faults: IA32 */
    EM_INTR_IA_COPROCESSOR_NOT_AVAILABLE_FAULT    = 39,
    EM_INTR_IA_FP_ERROR_FAULT                     = 40,
    /* Faults: IA32, IA64 */
    EM_INTR_REGISTER_NAT_CONSUMPTION_FAULT        = 41,
    /* Faults: IA64 */
    EM_INTR_RESERVED_REGISTER_FIELD_FAULT         = 42,
    EM_INTR_UNIMPLEMENTED_DATA_ADDRESS_FAULT      = 43,
    EM_INTR_PRIVILEGED_REGISTER_FAULT             = 44,
    EM_INTR_SPECULATIVE_OPERATION_FAULT           = 45,
    EM_INTR_VIRTUALIZATION_FAULT                  = 46,
    /* Faults: IA32 */
    EM_INTR_IA_STACK_EXCEPTION_FAULT              = 47,
    EM_INTR_IA_GENERAL_PROTECTION_FAULT           = 48,
    /* Faults: IA32, IA64 */
    EM_INTR_DATA_NESTED_TLB_FAULT                 = 49,
    EM_INTR_DATA_ALT_TLB_FAULT                    = 50,
    EM_INTR_DATA_VHPT_FAULT                       = 51,
    EM_INTR_DATA_TLB_FAULT                        = 52,
    EM_INTR_DATA_PAGE_NOT_PRESENT_FAULT           = 53,
    EM_INTR_DATA_NAT_PAGE_CONSUMPTION_FAULT       = 54,
    EM_INTR_DATA_KEY_MISS_FAULT                   = 55,
    EM_INTR_DATA_KEY_PERMISSION_FAULT             = 56,
    EM_INTR_DATA_ACCESS_RIGHT_FAULT               = 57,
    EM_INTR_DATA_DIRTY_BIT_FAULT                  = 58,
    EM_INTR_DATA_ACCESS_BIT_FAULT                 = 59,
    /* Faults: IA64 */
    EM_INTR_DATA_DEBUG_FAULT                      = 60,
    EM_INTR_UNALIGNED_DATA_REFERENCE_FAULT        = 61,
    /* Faults: IA32 */
    EM_INTR_IA_UNALIGNED_DATA_REFERENCE_FAULT     = 62,
    EM_INTR_IA_LOCKED_DATA_REFERENCE_FAULT        = 63,
    EM_INTR_IA_SEGMENT_NOT_PRESENT_FAULT          = 64,
    EM_INTR_IA_DIVIDE_BY_ZERO_FAULT               = 65,
    EM_INTR_IA_BOUND_FAULT                        = 66,
    EM_INTR_IA_KNI_NUMERIC_ERROR_FAULT            = 67,
    /* Faults: IA64 */
    EM_INTR_LOCKED_DATA_REFERENCE_FAULT           = 68,
    EM_INTR_FP_EXCEPTION_FAULT                    = 69,
    /* Traps: IA64 */
    EM_INTR_UNIMPLEMENTED_INST_ADDRESS_TRAP       = 70,
    EM_INTR_FP_TRAP                               = 71,
    EM_INTR_LOWER_PRIVILEGE_TARNSFER_TRAP         = 72,
    EM_INTR_TAKEN_BRANCH_TRAP                     = 73,
    EM_INTR_SINGLE_STEP_TRAP                      = 74,
    /* Traps: IA32 */
    EM_INTR_IA_SYSTEM_FLAG_INTERCEPT_TRAP         = 75,
    EM_INTR_IA_GATE_INTERCEPT_TRAP                = 76,
    EM_INTR_IA_INTO_TRAP                          = 77,
    EM_INTR_IA_BREAKPOINT_TRAP                    = 78,
    EM_INTR_IA_SOFTWARE_INTERRUPT_TRAP            = 79,
    EM_INTR_IA_DATA_DEBUG_TRAP                    = 80,
    EM_INTR_IA_TAKEN_BRANCH_TRAP                  = 81,
    EM_INTR_IA_SINGLE_STEP_TRAP                   = 82,
...
typedef enum
{
    ...
    EM_VECTOR_VIRTUALIZATION           = 0x6100,
    /*** reserved: 0x6200 through 0x6800 ***/
...
#define EM_ISR_CODE_ILLEGAL_DEPENDENCY           0x80
