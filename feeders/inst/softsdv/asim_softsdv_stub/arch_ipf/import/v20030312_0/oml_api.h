...
/* A type definition of the object’s properties. */
typedef enum{
	OML_OBJ_NAME,
	OML_OBJ_ALIAS_NAME,
	OML_OBJ_STATE ,
...
OML_EXPIMP GE_stat_t oml_obj_get_name(OML_handle_t handle,
							OML_name_t*   name_buf, unsigned* buf_size);
...
* stage. The object’s state is changed to "closed" after the closing was
...
* OML_ERR_NON_AUTHORIZED_TOOL	The object is restricted to owner’s update only,
