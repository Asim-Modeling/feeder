...
typedef enum EM_interruption_e
{
    ...
    /* Faults: IA32 */
    EM_INTR_IA_STACK_EXCEPTION_FAULT              = 46,
    EM_INTR_IA_GENERAL_PROTECTION_FAULT           = 47,
    /* Faults: IA32, IA64 */
    EM_INTR_DATA_NESTED_TLB_FAULT                 = 48, 
    EM_INTR_DATA_ALT_TLB_FAULT                    = 49,
    EM_INTR_DATA_VHPT_FAULT                       = 50,
    EM_INTR_DATA_TLB_FAULT                        = 51,
    EM_INTR_DATA_PAGE_NOT_PRESENT_FAULT           = 52,
    EM_INTR_DATA_NAT_PAGE_CONSUMPTION_FAULT       = 53,
    EM_INTR_DATA_KEY_MISS_FAULT                   = 54,
    EM_INTR_DATA_KEY_PERMISSION_FAULT             = 55,
    EM_INTR_DATA_ACCESS_RIGHT_FAULT               = 56,
    EM_INTR_DATA_DIRTY_BIT_FAULT                  = 57,
    EM_INTR_DATA_ACCESS_BIT_FAULT                 = 58,
    /* Faults: IA64 */
    EM_INTR_DATA_DEBUG_FAULT                      = 59,
    EM_INTR_UNALIGNED_DATA_REFERENCE_FAULT        = 60,
    /* Faults: IA32 */
    EM_INTR_IA_UNALIGNED_DATA_REFERENCE_FAULT     = 61,
    EM_INTR_IA_LOCKED_DATA_REFERENCE_FAULT        = 62,
    EM_INTR_IA_SEGMENT_NOT_PRESENT_FAULT          = 63,
    EM_INTR_IA_DIVIDE_BY_ZERO_FAULT               = 64,
    EM_INTR_IA_BOUND_FAULT                        = 65,
    EM_INTR_IA_KNI_NUMERIC_ERROR_FAULT            = 66,
    /* Faults: IA64 */
    EM_INTR_LOCKED_DATA_REFERENCE_FAULT           = 67,
    EM_INTR_FP_EXCEPTION_FAULT                    = 68,
    /* Traps: IA64 */
    EM_INTR_UNIMPLEMENTED_INST_ADDRESS_TRAP       = 69,
    EM_INTR_FP_TRAP                               = 70,
    EM_INTR_LOWER_PRIVILEGE_TARNSFER_TRAP         = 71,
    EM_INTR_TAKEN_BRANCH_TRAP                     = 72,
    EM_INTR_SINGLE_STEP_TRAP                      = 73,
    /* Traps: IA32 */
    EM_INTR_IA_SYSTEM_FLAG_INTERCEPT_TRAP         = 74,
    EM_INTR_IA_GATE_INTERCEPT_TRAP                = 75,
    EM_INTR_IA_INTO_TRAP                          = 76,
    EM_INTR_IA_BREAKPOINT_TRAP                    = 77,
    EM_INTR_IA_SOFTWARE_INTERRUPT_TRAP            = 78,
    EM_INTR_IA_DATA_DEBUG_TRAP                    = 79,
    EM_INTR_IA_TAKEN_BRANCH_TRAP                  = 80,
    EM_INTR_IA_SINGLE_STEP_TRAP                   = 81,
